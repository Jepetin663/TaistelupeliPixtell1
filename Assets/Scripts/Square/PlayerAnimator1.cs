...
public class PlayerAnimator : MonoBehaviour
{
    ...
    private void CheckAnimationState()
    {
        if (startedJumping)
        {
            ...
            GameObject obj = Instantiate(jumpFX, transform.position - Vector3.up * GetComponent<BoxCollider2D>().bounds.extents.y, Quaternion.Euler(-90, 0, 0));
            Destroy(obj, 1);
